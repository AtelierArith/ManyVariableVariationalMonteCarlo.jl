...
function main()
    ...
    for L in system_sizes
        ...
        for r in 1:min(L÷2, 8)  # Calculate up to half the system or 8 sites
            ...
            @printf("%3d       %8.5f ± %.4f   %8.5f    %8.5f\n", 
                   r, vmc_corr, error_est, theoretical_corr, deviation)
        end
    ...
    for L in system_sizes
        ...
        @printf("%-4d    %9.6f   ±%.4f    %9.6f   %9.6f\n", 
               L, energy, error, exact_energy, deviation)
    end
