...
@testitem "Enhanced RBM Basic Functionality" begin
    using ManyVariableVariationalMonteCarlo
...
@testitem "RBM Weight Calculations" begin
    using ManyVariableVariationalMonteCarlo
...
@testitem "RBM Gradient Calculations" begin
    using ManyVariableVariationalMonteCarlo
...
@testitem "Efficient RBM Gradient Calculations" begin
    using ManyVariableVariationalMonteCarlo
...
@testitem "RBM Parameter Management" begin
    using ManyVariableVariationalMonteCarlo
...
@testitem "Variational RBM Management" begin
    using ManyVariableVariationalMonteCarlo
...
@testitem "RBM Optimization History" begin
    using ManyVariableVariationalMonteCarlo
...
@testitem "RBM Regularization" begin
    using ManyVariableVariationalMonteCarlo
...
@testitem "RBM Ensemble" begin
    ...
    ensemble_weight = ensemble_rbm_weight(ensemble, visible_state, hidden_state, phys_state)
...
@testitem "RBM Performance" begin
    using ManyVariableVariationalMonteCarlo
...
@testitem "RBM Complex vs Real" begin
    using ManyVariableVariationalMonteCarlo
    ...
    weight_complex = rbm_weight_phys(rbm_complex, visible_state, hidden_state, phys_state)
    ...
    weight_real = rbm_weight_phys(rbm_real, visible_state, hidden_state, phys_state_real)
    @test isa(weight_real, Float64)
    @test imag(weight_real) == 0.0
end

@testitem "RBM Reset and Initialization" begin
    using ManyVariableVariationalMonteCarlo
