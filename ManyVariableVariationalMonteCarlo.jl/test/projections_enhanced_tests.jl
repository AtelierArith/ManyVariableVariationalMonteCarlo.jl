...
@testitem "Enhanced Quantum Projections Basic Functionality" begin
    using ManyVariableVariationalMonteCarlo
...
@testitem "Point Group Projections" begin
    using ManyVariableVariationalMonteCarlo
...
@testitem "Time Reversal Projections" begin
    using ManyVariableVariationalMonteCarlo
...
@testitem "Particle-Hole Projections" begin
    using ManyVariableVariationalMonteCarlo
...
@testitem "Advanced Quantum Projections" begin
    using ManyVariableVariationalMonteCarlo
...
@testitem "Cubic Symmetry Setup" begin
    using ManyVariableVariationalMonteCarlo
    ...
    identity_ops = filter(op -> op.operation_type == "Identity", aqp.point_group_projection.symmetry_operations)
...
@testitem "Continuous Projections" begin
    ...
    proj = ProjectionOperator{ComplexF64}(MOMENTUM_PROJECTION, ComplexF64(0.0), ComplexF64(1.0))
...
@testitem "Projection Complex vs Real" begin
    using ManyVariableVariationalMonteCarlo
...
@testitem "Symmetry Operation Edge Cases" begin
    using ManyVariableVariationalMonteCarlo
    ...
    @test_throws ArgumentError add_symmetry_operation!(pgp, "Wrong", wrong_matrix, ComplexF64(1.0))
...
@testitem "Projection Statistics" begin
    using ManyVariableVariationalMonteCarlo
