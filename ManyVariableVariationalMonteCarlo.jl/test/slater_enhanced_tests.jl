...
@testitem "Enhanced Slater Determinant Basic Functionality" begin
    using ManyVariableVariationalMonteCarlo
...
@testitem "Frozen-Spin Slater Determinant" begin
    using ManyVariableVariationalMonteCarlo
...
@testitem "Backflow Corrections" begin
    using ManyVariableVariationalMonteCarlo
...
@testitem "Backflow Slater Determinant" begin
    using ManyVariableVariationalMonteCarlo
...
@testitem "Slater Determinant Updates" begin
    using ManyVariableVariationalMonteCarlo
...
@testitem "Slater Determinant Determinant Calculations" begin
    using ManyVariableVariationalMonteCarlo
...
@testitem "Slater Determinant Performance" begin
    using ManyVariableVariationalMonteCarlo
...
@testitem "Slater Determinant Edge Cases" begin
    using ManyVariableVariationalMonteCarlo
...
@testitem "Slater Determinant Complex vs Real" begin
    using ManyVariableVariationalMonteCarlo
...
@testitem "Frozen-Spin Move Validation" begin
    using ManyVariableVariationalMonteCarlo
...
@testitem "Backflow Correction Edge Cases" begin
    using ManyVariableVariationalMonteCarlo
