...
export SimulationConfig,
    ...
    vmc_parameter_optimization!,
    vmc_physics_calculation!,
    vmc_make_sample!,
    vmc_main_calculation!,
    output_results,
    ...
    # C-compatible quantum projection
    CCompatQuantumProjection,
    init_qp_weight!,
    update_qp_weight!,
    initialize_quantum_projection_from_config,
    calculate_log_ip,
    calculate_ip,
    # Quantum projection integration
    apply_quantum_projection_to_wavefunction!,
    calculate_quantum_projection_ratio,
    update_quantum_projection_weights!,
    get_quantum_projection_info,
