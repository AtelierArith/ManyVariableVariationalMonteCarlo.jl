@testitem "jastrow" begin
    ...
    @testset "Jastrow Factor Basic Functionality" begin
    ...
    @testset "Jastrow Factor Calculations" begin
    ...
    @testset "Jastrow Factor Gradients" begin
    ...
    @testset "Jastrow Factor Parameter Management" begin
    ...
    @testset "Jastrow Factor Performance" begin
    ...
    @testset "Jastrow Factor Edge Cases" begin
    ...
    @testset "Jastrow Factor Complex vs Real" begin
